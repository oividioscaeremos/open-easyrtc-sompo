...
option.appIceServers = [ // Array of STUN and TURN servers. By default there is only publicly available STUN servers.
    ...
    },
    {
        ...
        username: "piw8B_Ll62pJqTwpjBSL5Wlg_kuXh3NvkR8HKnmVVylenjzeSV-z18Gib3HDQ-XzAAAAAF2-BKppbGtlcmF0YWJheQ==",
        credential: "0e804b1c-fdc1-11e9-8ae9-4a049da423ff",
        urls: ["turn:eu-turn2.xirsys.com:80?transport=udp", "turn:eu-turn2.xirsys.com:3478?transport=udp", "turn:eu-turn2.xirsys.com:80?transport=tcp", "turn:eu-turn2.xirsys.com:3478?transport=tcp", "turns:eu-turn2.xirsys.com:443?transport=tcp", "turns:eu-turn2.xirsys.com:5349?transport=tcp"]
    }
];
...
//
// option for stillAlive timer to eliminate zombies.
// Set to zero if you don't want stillAlive messages firing.
//
option.stillAliveInterval = 20 * 1000; // how frequently the client fires still alives. In milliseconds.
option.stillAliveGracePeriod = 10000; // Extra time allowed before a stillAlive is considered missed
